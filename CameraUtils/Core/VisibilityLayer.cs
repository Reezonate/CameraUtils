...
namespace CameraUtils.Core {
    public enum VisibilityLayer {
        ...
        HmdOnly = 17, //<----------- Not used in Vanilla
        DesktopOnly = 18, //<----------- Not used in Vanilla
        NonReflectedParticles = 19,
        EnvironmentPhysics = 20,
        AlwaysVisible = 21, //<----------- Not used in Vanilla
        Event = 22,
        DesktopOnlyAndReflected = 23, //<----------- Not used in Vanilla
        HmdOnlyAndReflected = 24, //<----------- Not used in Vanilla
        FixMRAlpha = 25,
        AlwaysVisibleAndReflected = 26, //<----------- Not used in Vanilla
